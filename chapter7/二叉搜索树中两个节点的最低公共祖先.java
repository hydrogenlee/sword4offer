...
public class 二叉搜索树中两个节点的最低公共祖先 {
    ...
    public static void main(String[] args) {
        ...
        // 默认root不为空
        System.out.println(lowestCommonAncestor(root, root.left, root.right).val);           // 2 和 8, 结果为6
        System.out.println(lowestCommonAncestor(root, root.left, root.left.right).val);      // 2 和 4，结果为2
