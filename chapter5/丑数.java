...
public class 丑数 {
    public static void main(String[] args) {
        ...
        System.out.println(solution.getUglyNumber(1));           // 1
        System.out.println(solution.getUglyNumber(2));           // 2
        System.out.println(solution.getUglyNumber(3));           // 3
        System.out.println(solution.getUglyNumber(4));           // 4
        System.out.println(solution.getUglyNumber(5));           // 5
        System.out.println(solution.getUglyNumber(1500));        // 859963392
    }
    ...
    class Solution {
        ...
        // 直接求解 超时了
        public int getUglyNumberBruteForce(int index) {
            if (index <= 0) {
                throw new IllegalArgumentException("输入的参数有误");
            }
