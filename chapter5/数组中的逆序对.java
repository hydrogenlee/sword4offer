...
public class 数组中的逆序对 {
    public static void main(String[] args) {
        ...
        System.out.println(solution.inversePairs(new int[]{7, 5, 6, 4}));                // 5
        System.out.println(solution.inversePairs(new int[]{1, 2, 3, 4, 5, 6, 7, 0}));    // 7
    }
    ...
    class Solution {
        ...
        private long mergeSort(int[] array, int start, int end) {
            if (start >= end) {
                return 0;
            }
