...
public class 删除出现过的所有字符 {
    public static void main(String[] args) {
        Solution solution = new 删除出现过的所有字符().new Solution();
        System.out.println(solution.deleteExistingChars("We are students. ", "aeiou"));
    }

    class Solution {
        public String deleteExistingChars(String original, String deleteChars) {
