...
public class 把数组排成最小数 {
    public static void main(String[] args) {
        System.out.println(printMinNumber(new int[]{3, 32, 321}));          // 321323
        System.out.println(printMinNumber(new int[]{3, 34, 321}));          // 321334
        System.out.println(printMinNumber(new int[]{1, 32, 321}));          // 132132
    }
