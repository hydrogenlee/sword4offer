...
public class 从1到n整数中1出现的次数 {
    public static void main(String[] args) {
        System.out.println(countNumberOf1Between1AndN(12));         // 5
        System.out.println(countNumberOf1Between1AndN(13));         // 6
    }
    ...
    private static int countNumberOf1Between1AndN(int n) {
        if (n <= 0) {
            return 0;
        }
