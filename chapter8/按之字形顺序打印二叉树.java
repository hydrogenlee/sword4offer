...
public class 按之字形顺序打印二叉树 {
    public static void main(String[] args) {
        ...
        ArrayList<ArrayList<Integer>> result = printUsingTwoStack(root);
        ...
        System.out.println("------------------------------");
        // 如果不需要返回，直接在函数里面打印
        printDirectlyInFunctionUsingTwoStack(root);
    }

    // 使用两个栈
    public static ArrayList<ArrayList<Integer>> printUsingTwoStack(TreeNode pRoot) {
        if (pRoot == null) {
    ...
    //使用两个栈，但是直接在函数内部打印
    public static void printDirectlyInFunctionUsingTwoStack(TreeNode pRoot) {
        if (pRoot == null) {
            return;
        }
    ...
    // 使用队列
    // 通过null来分层
    public static ArrayList<ArrayList<Integer>> printUsingQueue(TreeNode pRoot) {
        if (pRoot == null) {
            return new ArrayList<>();
        }
        ArrayList<ArrayList<Integer>> result = new ArrayList<>();
