...
public class 数组中只出现一次的两个数字 {
    public static void main(String[] args) {
        Solution solution = new 数组中只出现一次的两个数字().new Solution();
        int[] num1 = new int[1];
        int[] num2 = new int[1];
        solution.findNumsAppearOnce1(new int[]{2, 4, 3, 6, 3, 2, 5, 5}, num1, num2);
        System.out.println("num1: " + num1[0] + "\tnum2: " + num2[0]);
        System.out.println("-------------------------------------");
        num1[0] = -1;
        num2[0] = -1;
        solution.findNumsAppearOnce2(new int[]{2, 4, 3, 6, 3, 2, 5, 5}, num1, num2);
        System.out.println("num1: " + num1[0] + "\tnum2: " + num2[0]);
    }
