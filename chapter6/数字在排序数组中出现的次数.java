...
public class 数字在排序数组中出现的次数 {
    public static void main(String[] args) {
        System.out.println(getNumberOfKMethod1(new int[]{3}, 3));                          // 0
        System.out.println(getNumberOfKMethod1(new int[]{3, 3, 3, 3, 4, 5}, 3));           // 4
        System.out.println(getNumberOfKMethod1(new int[]{1, 2, 3, 3, 3, 3, 4, 5}, 3));     // 4
        System.out.println("----------------------");
        System.out.println(getNumberOfKMethod2(new int[]{3}, 3));                          // 0
        System.out.println(getNumberOfKMethod2(new int[]{3, 3, 3, 3, 4, 5}, 3));           // 4
        System.out.println(getNumberOfKMethod2(new int[]{1, 2, 3, 3, 3, 3, 4, 5}, 3));     // 4
    }
    ...
    // 使用二分查找的方法
    // 先找到一个k，然后再左右查找
    public static int getNumberOfKMethod2(int[] array, int k) {
        if (array == null || array.length == 0 || k < array[0] || k > array[array.length - 1]) {
            return 0;
        }
