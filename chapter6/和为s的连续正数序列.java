...
public class 和为s的连续正数序列 {
    public static void main(String[] args) {
        ...
        printList(solution.findContinuousSequence(15));
        System.out.println("-----------------");
        printList(solution.findContinuousSequence(100));
        System.out.println("==============Optimized===============");
        printList(solution.findContinuousSequenceOptimized(15));
        System.out.println("-----------------");
        printList(solution.findContinuousSequenceOptimized(100));
    ...
    class Solution {
        // 这是下面函数的优化版本
        public ArrayList<ArrayList<Integer>> findContinuousSequenceOptimized(int sum) {
            if (sum <= 2) {
