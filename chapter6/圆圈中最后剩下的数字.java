...
public class 圆圈中最后剩下的数字 {
    public static void main(String[] args) {
        ...
        System.out.println(solution.lastRemainingOptimized(5, 2));        // 2
        System.out.println(solution.lastRemainingOptimized(5, 3));        // 3
        System.out.println("------------------------------");
        System.out.println(solution.lastRemaining(5, 2));        // 2
    ...
    class Solution {
        ...
        // T-C: O(N)
        // S-C: O(1)
        public int lastRemainingOptimized(int n, int m) {
            if (n <= 0 || m <= 0) {
                return -1;
            }
