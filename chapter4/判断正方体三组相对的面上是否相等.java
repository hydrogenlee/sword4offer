...
public class 判断正方体三组相对的面上是否相等 {
    public static void main(String[] args) {
        ArrayList<ArrayList<Integer>> result = solution(new int[]{1, 2, 3, 4, 5, 6, 7, 8});
        ...
        System.out.println("-------------------------------");
        result = solution(new int[]{1, 1, 1, 1, 2, 2, 2, 2});
        ...
        System.out.println("-------------------------------");
        result = solution(new int[]{1, 1, 1, 1, 1, 1, 1, 1});
    ...
    private static ArrayList<ArrayList<Integer>> solution(int[] numbers) {
    ...
    private static void doPermutation(ArrayList<ArrayList<Integer>> result,
