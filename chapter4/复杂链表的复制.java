...
import sword4offer.util.RandomListNode;
...
public class 复杂链表的复制 {
    public static void main(String[] args) {
        ...
        printRandomList(solution.clone(A));

        System.out.println("-----------Method2-----------");
        printRandomList(solution.clone2(A));

        System.out.println("-----------Method3-----------");
        printRandomList(solution.clone3(A));
    }

    private static void printRandomList(RandomListNode result) {
        while (result != null) {
